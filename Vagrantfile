...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sripad-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sripad"
  #   chef.validation_client_name = "sripad-validator"
  #   chef.validation_key_path = ".chef/sripad-validator.pem"
  # end
end
